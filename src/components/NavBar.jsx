...
export default function Navbar() {
  ...
  return (
    <Disclosure
      as="nav"
      className="fixed top-0 left-0  right-0 z-30 h-16 relative bg-white shadow-sm dark:bg-gray-800/50 dark:shadow-none dark:after:pointer-events-none dark:after:absolute dark:after:inset-x-0 dark:after:bottom-0 dark:after:h-px dark:after:bg-white/10"
    >
